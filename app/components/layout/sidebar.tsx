...
export const Sidebar = memo(function Sidebar({ session, rootAdminTheme = false }: { session: CurrentSession | null; rootAdminTheme?: boolean }) {
  ...
  return (
    <aside className={cn("studio-sidebar hidden shrink-0 px-2 py-4 md:flex md:w-24 md:flex-col lg:w-56 lg:px-4 lg:py-6 xl:w-64", rootAdminTheme ? "border-r border-emerald-300/15 bg-[#04110A]" : "border-r border-[#F4C7C4]/50 bg-white/50")}>
