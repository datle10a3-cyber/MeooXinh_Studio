    ...
    <main className="min-h-screen overflow-hidden bg-[#FFF3EC] px-4 py-8 text-[#5B342C]">
      ...
      <section className="relative mx-auto grid min-h-[calc(100vh-4rem)] w-full max-w-6xl items-center gap-8 lg:grid-cols-[1.05fr_0.95fr]">
        ...
        <form onSubmit={submit} className="rounded-[2rem] border border-[#F4C7C4] bg-white/90 p-6 shadow-[0_20px_60px_rgba(127,69,60,0.16)] backdrop-blur">
          ...
          <Link prefetch={false} href="/forgot-password" className="mt-3 block text-center text-sm font-black text-[#A84E61] transition hover:text-[#EA7188]">
            Quên mật khẩu?
          </Link>

          <Link prefetch={false} href="/register" className="mt-5 block rounded-2xl border border-[#F4C7C4] bg-white px-4 py-3 text-center text-sm font-black text-[#EA7188] shadow-sm transition hover:bg-[#FFF3EC]">
